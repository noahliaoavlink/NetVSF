...
// testVSFServer.cpp: 定義應用程式的類別表現方式。
//
...
BEGIN_MESSAGE_MAP(CtestVSFServerApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CtestVSFServerApp 建構

CtestVSFServerApp::CtestVSFServerApp()
{
	// 支援重新啟動管理員
...
// 唯一一個 CtestVSFServerApp 物件

CtestVSFServerApp theApp;


// CtestVSFServerApp 初始化

BOOL CtestVSFServerApp::InitInstance()
{
