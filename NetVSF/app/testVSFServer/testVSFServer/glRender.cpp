...
//	HGLRC hRC = wglGetCurrentContext();
	...
	m_pglTexture->AllocateOutputImage(w,h);
...
void glRender::CopyTexture2Image()
{
	HGLRC hRC = wglGetCurrentContext();
	...
	m_pglTexture->CopyTexture();
}

unsigned char* glRender::GetOutputImage()
{
	return m_pglTexture->GetOutputImage();
}
