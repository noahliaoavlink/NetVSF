...
// testVSFClient.cpp: 定義應用程式的類別表現方式。
//
...
BEGIN_MESSAGE_MAP(CtestVSFClientApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CtestVSFClientApp 建構

CtestVSFClientApp::CtestVSFClientApp()
{
	// 支援重新啟動管理員
...
// 唯一一個 CtestVSFClientApp 物件

CtestVSFClientApp theApp;


// CtestVSFClientApp 初始化

BOOL CtestVSFClientApp::InitInstance()
{
