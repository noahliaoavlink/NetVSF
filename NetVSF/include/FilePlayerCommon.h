...
class FilePlayerCallback2
{
	public:
		virtual void DisplayVideo(int iIndex, unsigned char* pBuffer, int w, int h) = 0;
		virtual void DisplayVideo_HW(int iIndex, void* pD3DDevice, unsigned char* pBuffer, int w, int h) = 0;
};
